    ...
    data.forEach(beach => {
        html += `
            <tr>
                ...
                <td class="icon-cell">
                    ${beach.has_lifeguard
            ? '<span class="badge badge-yes"><i class="fas fa-check"></i> 有</span>'
            : '<span class="badge badge-no"><i class="fas fa-times"></i> 无</span>'}
                </td>
                <td class="icon-cell">
                    ${beach.has_shower
            ? '<span class="badge badge-yes"><i class="fas fa-check"></i> 有</span>'
            : '<span class="badge badge-no"><i class="fas fa-times"></i> 无</span>'}
                ...
                <td class="icon-cell">
                    ${beach.is_free
            ? '<span class="badge badge-free"><i class="fas fa-check"></i> 免费</span>'
            : '<span class="badge badge-paid"><i class="fas fa-yen-sign"></i> 收费</span>'}
                </td>
                <td>
